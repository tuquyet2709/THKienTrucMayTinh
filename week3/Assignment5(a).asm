#Laboratory 3, Assigment 5(a) i < n
.data 
...
loop: 
  ...
  slt $t2, $s1,$s3   # so sanh i va n, i < n thi $t2 bang 1
  bne  $t2,$zero,loop    #Neu $t2 khac 0, goto loop 
#i < n nen khi i >= n thi se tiep tuc vong lap