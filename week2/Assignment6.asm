...
.text                      # DECLARE INSTRUCTIONS  
 ...
 # Lenh la duoc bien dich nhu sau :
 # Chuyen thanh 2 lenh lui va ori, lui luu gia tri cua X vao thanh ghi at, sau do dung lenh ori ghep vao cac so 0 phia sau, ket qua $t8 co gia tri 0x10010000